...
exports.testKeyPair = exports.decryptValue = exports.desencriptarValor = exports.encriptarValor = exports.getPrivateKey = exports.getPublicKey = exports.getRSAKeys = exports.generateRSAKeys = void 0;
...
const getRSAKeys = () => __awaiter(void 0, void 0, void 0, function* () {
...
const testKeyPair = () => __awaiter(void 0, void 0, void 0, function* () {
    const { privateKeyPem, publicKeyPem } = yield (0, exports.getRSAKeys)();
    // Mensaje a encriptar
    const message = 'Hello, World!';
    console.log('Llave privada (PEM): \n', privateKeyPem);
    console.log('Llave pública (PEM): \n', publicKeyPem);
    // Encriptar el mensaje con la clave pública
    const encrypted = encriptarValor(publicKeyPem, message);
    console.log('Mensaje encriptado:', forge.util.encode64(encrypted));
    // Desencriptar el mensaje con la clave privada
    const decrypted = desencriptarValor(privateKeyPem, encrypted);
    console.log('Mensaje desencriptado:', decrypted);
});
exports.testKeyPair = testKeyPair;
